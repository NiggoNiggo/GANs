...
def parse_gan_args(selcted_gan, remaining_args):
    ...
    if selcted_gan in ["wgan","cgan","dcgan"]:
        ...
        parser.add_argument('--d', type=int, default=8, help='Model complexity')
        ...
        parser.add_argument('--lr_d', type=float, default=1e-6, help='Lernrate für Criticer in Wavegan')
        parser.add_argument('--audio_size', type=int, default=65536,choices=[16384,65536], help='Length of the audio signal')
        parser.add_argument('--lam', type=float, default=10, help='Lambda für WGAN')
        parser.add_argument('--n_crit', type=int, default=2, help='Anzahl der Kritiker bei WGAN')
        parser.add_argument('--alpha', type=float, default=0.0001, help='Alpha für WGAN')
        parser.add_argument('--betas', type=float, nargs=2, default=(0.9, 0.999), help='Betas für den Adam-Optimizer bei WGAN')
